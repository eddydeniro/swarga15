    ...
    <body>
        ...
        <div id="login-container">
                ...
                <form id="form-validation" action="" method="post" class="form-horizontal">
                    <div class="form-group">
                        <div class="col-xs-12">
                            ...
                            <span class="help-block"><marquee><strong>NB : NIK harus sesuai dengan NIK di Kartu Keluarga</strong></marquee></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-xs-12">
            ...
            <footer class="text-muted text-center animation-pullUp">
                <small><span>2019</span> &copy; <a href="http://">RW.15 BATREG-LAKSANAMEKAR BANDUNG BARAT 40553</a></small>
            </footer>
            <!-- END Footer -->
        </div>
        <!-- END Login Container -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Web ini adalah sarana komunikasi dan pusat data Penduduk RW. 15 Batujajar Regency</p>
                        <h4 class="page-header">2. <strong>Akun</strong></h4>
                        <p>Penduduk yang bisa mendaftar dan login adalah Peduduk yang telah memiliki KTP dan KK RW. 15 Batujajar Regency Desa Laksanamekar Kecamatan Padalarang Kabupaten Bandung Barat </p>
